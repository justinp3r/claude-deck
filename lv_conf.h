 ...
 * davon abweichend: LV_MEM_SIZE 96K statt 64K, LV_BUILD_EXAMPLES aus.
 *
 * LVGL sucht diese Datei als "../../lv_conf.h" relativ zu lvgl/src/,
 * sie muss also als ~/Documents/Arduino/libraries/lv_conf.h liegen.
 * scripts/setup.sh kopiert sie dorthin.
 */
/**
 * @file lv_conf.h
 ...
 */
/* CLIB statt BUILTIN: LVGL zeichnet transformierte Objekte (Clawds Drehung)
 * in eine eigene Ebene, deren Puffer auf dem LVGL-Heap liegt. Mit dem
 * eingebauten Allokator ist das ein statisches Array im internen RAM - dort
 * ging der Speicher aus, LVGL wartete endlos auf die Ebene und der
 * Task-Watchdog schlug zu. Ueber malloc landen grosse Bloecke im PSRAM. */
...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    #define LV_MEM_SIZE (96 * 1024U)          /**< [bytes] - hochgesetzt von 64K: alle Zustaende liegen gleichzeitig im Speicher */
